...
- State:
  - Done:
    ...
    - Pushed commit `9c602c3` to origin with inline device links and updated install copy.
  - Now:
    ...
    - Pull latest changes on server (commit `9c602c3`) and restart bot(s).
    ...
    - Server currently on commit `232afae`; needs `git pull` to get `9c602c3` and restart services.
